...
- Unreleased - **Breathe v4.31.0**
  ...
  - Fix duplicate ``static`` in function declarations. `#717 <https://github.com/michaeljones/breathe/pull/717>`__ `#720 <https://github.com/michaeljones/breathe/pull/720>`__
  ...
  - Test again Sphinx 4.0.3, 4.1.2 and 4.1.x branch. `#721 <https://github.com/michaeljones/breathe/pull/721>`__
