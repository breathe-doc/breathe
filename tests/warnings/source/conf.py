...
htmlhelp_basename = 'TestBreatheWarningsdoc'
...
latex_documents = [
  ('index', 'TestBreatheWarnings.tex', u'Test Breathe Warnings Documentation',
...
man_pages = [
    ('index', 'testbreathewarnings', u'Test Breathe Warnings Documentation',
     [u'Michael Jones'], 1)
]
...
texinfo_documents = [
  ('index', 'TestBreatheWarnings', u'Test Breathe Warnings Documentation',
   u'Michael Jones', 'TestBreatheWarnings', 'One line description of project.',
   'Miscellaneous'),
]
